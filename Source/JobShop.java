...
public class JobShop
{
  ...
  /* Suggested */synchronized void addProductRequest ( Part [] pr    ) { 
      this.productRequests.add(pr) ; 
  }
  /* Suggested */synchronized void addWorkingOrder   ( Order   order ) { 
      this.workingOrders.add(order) ; 
  /* ... */ }
  /* Suggested */synchronized void addCompletedOrder ( Order   order ) { 
      this.completedOrders.add(order) ; 
  /* ... */ }
  /* Suggested */synchronized void addMissingPart    ( String  part  ) { /* ... */ 
      this.missingParts.add(part) ; 
  }

  //=================================================================================================================================================

  /* Suggested */ public synchronized  Part [] getNextProductRequest ()  { 
      return productRequests.poll();
  }
  /* Suggested */ public synchronized Order   getNextWorkingOrder   ()  { /* ... */return workingOrders.poll(); }
  /* Suggested */ public synchronized String  getNextMissingPart    ()  { /* ... */return missingParts.poll(); }
